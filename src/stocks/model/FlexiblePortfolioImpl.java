...
public class FlexiblePortfolioImpl extends AbstractPortfolio implements IFlexible {
  ...
  public void dollarCostStrategy(String portfolioName,
                                 Map<String, Double> stockAndPercent, double investmentAmount, double commissionFee, int investmentInterval, String dateStart, String dateEnd) throws IllegalArgumentException {
    StrategyInterface strategy = new DollarCostStrategyImpl(investmentInterval,
            dateStart, dateEnd, this);
