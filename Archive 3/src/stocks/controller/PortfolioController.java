 ...
 * The main objective of this interface is to get inputs from the user and
 * call the corresponding model functions accordingly and display output to user via view.
 */
